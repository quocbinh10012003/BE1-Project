				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<form action="findpro?page=1" method="post">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="store?page=1" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="./img/ip14.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Iphone 14<br>Collection</h3>
								<a href="store?page=1" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Apple Watch<br>Collection</h3>
								<a href="store?page=1" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									?>
									<li>
										<a href="index_category.php?id=<?php echo $value['id'] ?>">&nbsp;<?php echo $value['name'] ?>&nbsp;</a>
...
<?php
					...
					$products = $data->FindProducts($id);

					// $id_danhmuc = 2022;
					// $dataz = new ProductsDAO();
					// $productsfind = $dataz->FindProducts($id_danhmuc);
?>		
					...
					<div class="col-md-12">
						<div class="row">
							<div class="products-tabs">
								<!-- tab -->
								<div id="tab2002" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										?>
										<div class="product">
											<a href="details?id=<?php echo $value['id']?>">
												<div class="product-img">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="details?id=<?php echo $value['id']?>"><?php echo $value['name'] ?></a></h3>
											...
											<div class="add-to-cart">
                                                <a href="cart_controller.php?id=<?php echo $value['id'] ?>">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="store?page=1">Shop now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
