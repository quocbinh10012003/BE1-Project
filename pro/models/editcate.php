                                ...
                                ?>
                                    <div class="product-widget">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <a href="delcate_controller?id=<?php echo $value['id']?>"><i class="fa fa-solid fa-trash"></i> Delete</a>
                                            </button>
                                            </h3>
                                            <h4 class="product-price"><a href="#"><?php echo $value['detail']?>
                                            <button>
                                            <a href="updatecate?id=<?php echo $value['id']?>"><i class="fa fa-gear"></i> Edit</a>
                                            </button></h4>
                                        </div>
                                    </div>
                                    <!-- /product widget -->
