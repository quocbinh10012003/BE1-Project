...
<html lang="en">
	...
	<body>
		...
		$prodetail = $data->FindAllProducts($idzz);
		?>
		<!-- SECTION -->
	<div class="section">
		<!-- container -->
			...
			<div class="row">
				...
				<div class="col-md-5">
					<div class="product-details">
						...
						<div>
							<h3 class="product-price">$<?php echo $value['price']?> <del class="product-old-price">$<?php echo $value['price']+20?></del></h3>
